  ...
  return (
    <div className="absolute select-none z-50 flex items-center gap-2 justify-center h-10  left-5 bottom-5">
      <button
        ...
        className="bg-foreground/80 backdrop-blur-2xl border-white/10 hover:text-green-400 border cursor-pointer rounded-md h-full px-4"
      >
        <FaMinus />
      </button>
      <p className="bg-foreground/80 backdrop-blur-2xl rounded-md h-full border-white/10 border text-center flex items-center px-4">
        {zoomPercentage}%
      </p>
      <button
